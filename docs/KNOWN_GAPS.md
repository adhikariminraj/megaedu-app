...
| F3 | Low ⚠️ | Bulk routes do not map Prisma `P2034` (deadlock / serialization failure) — one would surface as a `500`. PG-KM9 observed **0 deadlocks** (including the reversed-order probe W3b). | Map `P2034` to `409`/`503`; optionally a consistent insert order. |
