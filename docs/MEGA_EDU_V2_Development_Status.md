...
| PostgreSQL readiness | 🟡 development database on PostgreSQL (branch `pg-foundation`, not merged; verified PG-KM1–PG-KM10); bulk routes fixed (PG-KM2); F1, F2 and F8 fixed, F3–F7 open ([KNOWN_GAPS.md](KNOWN_GAPS.md#postgresql-findings-f1f8)); staging/production undecided (updated 2026-09-26) |
