...
4. PostgreSQL trial migration. — *done in development 2026-09-25 (PG-KM3–PG-KM10, branch `pg-foundation`, not merged; F1 and F2 rules A6/A5 fixed; F2 rules A1–A4 and F3–F7 open)*
