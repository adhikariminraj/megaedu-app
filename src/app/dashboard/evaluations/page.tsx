...
export default async function EvaluationsPage({
  ...
  // rows via getAccessibleSchools(), matching this page's already-
  // correct sibling (dashboard/schools/[schoolId]/evaluations/page.tsx).
  // This unscoped page has no per-teacher chooser UI of its own, so a
  // teacher with 2+ ACTIVE schools is sent to /dashboard, whose own
  // Teacher branch already implements the real chooser.
  let schoolId: string;
